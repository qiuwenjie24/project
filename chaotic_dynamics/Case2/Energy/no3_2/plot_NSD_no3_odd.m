...
s_aver = sum(E_gap_new)/size(E_gap_new,1);    %average energy gasp 1111111111111111111
% E_gap_new/s_aver
h2=histogram( E_gap_new/s_aver,edges); 
h2.Normalization = 'pdf';   %频数变频率密度
