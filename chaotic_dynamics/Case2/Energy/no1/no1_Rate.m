...
for i1=1:5
if i1==1
    load('Energy_even_no1_c1.mat','En_even') 
elseif i1==2
    load('Energy_even_no1_c2.mat','En_even') 
elseif i1==3
    load('Energy_even_no1_c3.mat','En_even') 
elseif i1==4
    load('Energy_even_no1_c4.mat','En_even') 
elseif i1==5
    load('Energy_even_no1_c5.mat','En_even') 
end
%% level spacing
