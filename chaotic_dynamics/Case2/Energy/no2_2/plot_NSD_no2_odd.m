...
text(2.5,0.65,'(a) $c=0$','fontsize',30,'interpreter','latex')
...
text(2.5,0.65,'(b) $c=1$','fontsize',30,'interpreter','latex')
set(gca,'fontsize',20,'linewidth',1.5)
% axis([-0.2,5,0,600])
...
text(2.5,0.65,'(c) $c=10$','fontsize',30,'interpreter','latex')
% axis([-0.2,5,0,600])
%% (d)c=100
subplot('position',pos4); 
clearvars -except pos1 pos2 pos3 pos4 edges
load('Energy_odd_no2_c4.mat')   
