...
load('Energy_all_no2_c1.mat')  

E_r=sortrows(En_all,1) ;    % 排序
n=size(E_r,1);
E_gap=zeros(n-1,1);
for i=1:1:n-1
...
text(2.5,1.3,'(a) $c=0$','fontsize',30,'interpreter','latex')
