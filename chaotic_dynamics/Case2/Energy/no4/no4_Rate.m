...
for i1=-1:7
if i1==-1
    load('Energy_even_no4_c1.mat','En_even') 
elseif i1==0
    load('Energy_even_no4_c2.mat','En_even') 
elseif i1==1
    load('Energy_even_no4_c3.mat','En_even') 
elseif i1==2
    load('Energy_even_no4_c4.mat','En_even') 
elseif i1==3
    load('Energy_even_no4_c4p3.mat','En_even') 
elseif i1==4
    load('Energy_even_no4_c4p4.mat','En_even') 
elseif i1==5
    load('Energy_even_no4_c4p5.mat','En_even') 
elseif i1==6
    load('Energy_even_no4_c4p6.mat','En_even') 
elseif i1==7
    load('Energy_even_no4_c5.mat','En_even') 
end
%% level spacing
...
% figure
hold on
plot(10.^(0:6),Rate(1:7),'diamond-r','LineWidth',2,'MarkerSize',20,...
    'MarkerFaceColor','r')
% axis([0,0.9,0,0.81])
% xlim([0,10^12])
set(gca,'XScale','log','fontsize',25,'linewidth',1.5)
xlabel('c')
ylabel('R(c)')
legend('$\eta=f^{-1}(\frac{1}{5})$','$\eta=f^{-1}(\frac{3-\sqrt{5}}{4})$',...
