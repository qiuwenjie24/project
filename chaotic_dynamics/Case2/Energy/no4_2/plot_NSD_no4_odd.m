...
text(0.9,0.65,'(a) $\eta=f^{-1}(\frac{3-\sqrt{5}}{4}),c=0$',...
...
text(2.5,0.65,'(b) $c=1$','fontsize',35,'interpreter','latex')
% axis([-0.2,5,0,600])

%% (c)c=10
subplot('position',pos3); 
clearvars -except pos1 pos2 pos3 pos4 edges
load('Energy_odd_no4_c3.mat')     
...
text(2.5,0.65,'(c) $c=10$','fontsize',35,'interpreter','latex')
% axis([-0.2,5,0,600])
%% (d)c=100
subplot('position',pos4); 
clearvars -except pos1 pos2 pos3 pos4 edges
load('Energy_odd_no4_c4.mat')   
