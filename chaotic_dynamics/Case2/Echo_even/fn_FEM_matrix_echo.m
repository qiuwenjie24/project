...
function fn_FEM_matrix_echo(m1,m2)
%% 参数
% tic
L=1;
...
%% save 
clearvars -except m1 m2 mh1 mh2 p boundary n_p A N M A_odd N_odd M_odd ...
                  A_even N_even M_even

if m1==1 && m2 == 1
   save('matrix_echo_no1.mat','-v7.3')
elseif m1==1 && m2 == 1/3
    save('matrix_echo_no2.mat','-v7.3')
elseif m1==1 && m2 == (tan(1/5*pi) )^2
    save('matrix_echo_no3.mat','-v7.3')
elseif m1==1 && m2 == (tan((3-sqrt(5) )/4*pi) )^2
    save('matrix_echo_no4.mat','-v7.3')
end
