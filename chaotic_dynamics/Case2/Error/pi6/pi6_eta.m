...
for i1=1:5
if i1==1
    load('E:\Data二体碰撞模型2\Energy\no2\Energy_even_no2_c1.mat','En_even')
elseif i1==2
    load('BAroots_finite_even_c1.mat','En_even2')
    En_even = En_even2;
elseif i1==3
    load('BAroots_finite_even_c10.mat','En_even2')
    En_even = En_even2;
elseif i1==4
    load('BAroots_finite_even_c100.mat','En_even2') 
    En_even = En_even2;
elseif i1==5
    load('E:\Data二体碰撞模型2\Energy\no2\Energy_even_no2_c5.mat','En_even') 
end
%% level spacing
...
Rate(i1)=abs( (int_P- int_P_w)/(int_P_p- int_P_w) )
